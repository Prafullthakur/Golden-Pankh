  ...
  return (
    <section class="mdf pb-4">
      <div class="container">
        ...
        <p class="pb-4">
          It is a beautifully designed and finely finished Decorative Hypercube
          developed using high-grade metals. It comes in elegant design with
          perfect finishing to provide amazing looks. Its fine polishing ensures
          it to keep safe against different adverse weather conditions. This is
          developed in creative design with unmatched styles to provide an
          amazing style to the spaces from homes to offices to hotels. In
