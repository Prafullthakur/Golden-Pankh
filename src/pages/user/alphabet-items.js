        ...
        <div className="prod py-4 pl-3">
          <div className="row">
            ...
            <div className="col-md-7">
              <h3>Decorative Alphabets Letters</h3>
              <h6 className="price">Price: 3 USD ($)</h6>
              ...
              <table>
                ...
                <tr>
                  <td>Length</td>
                  <td>10 Centimeter (cm)</td>
                </tr>
                <tr>
                  <td>Feature</td>
                  <td>
                    Easy To Install, Non Toxic, Rust Proof,
                    <br /> Easy To Clean, Durable
                  </td>
                </tr>
                <tr>
                  <td>Height</td>
            ...
            <div className="col-md-6">
              <table>
                ...
                <tr>
                  <td>Feature</td>
                  <td>
                    Easy To Install, Light Weight, Easy To <br /> Clean, Durable
                  </td>
                </tr>
              </table>
            </div>
            ...
            <div className="col-md-6">
              <table>
                ...
                <tr>
                  ...
                  <td>
                    Africa, Middle East, Western Europe, Eastern Europe, North
